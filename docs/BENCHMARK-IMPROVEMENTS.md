...
| #      | Improvement                                                                                                                                                                                                                                                                                                            | Why                                                                                                                                                                                  | Benefit | Status                                                                                                                                                  |
| ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| P1-1   | **"How we work" redesigned as a connected Client Journey Timeline** — numbered markers on a path (horizontal desktop / vertical mobile) instead of three flat tiles.                                                                                                                                                   | A visible, connected path shows an anxious applicant exactly what happens next; "journey" reads as guidance, tiles read as a brochure. Fully CMS-driven; number added automatically. | 🛡️🎨    | ✅ Implemented & structurally verified (mobile/desktop, semantic `<ol>`, no h-scroll, 0 console errors); **live on the preview for your visual review** |
| _next_ | Homepage storytelling arc & resequencing · hero trust micro-proof (live rating) · rich Success Stories (video/testimonial/outcome cards) · differentiated "Why choose us" · practitioner card (photo-ready) · CTA placement · consultation flow · service pages · blog reading experience · author credibility · FAQs. | See the P1 brief + chat proposal.                                                                                                                                                    | 🛡️🎯🎨  | ⏳ Proposed — direction in chat                                                                                                                         |
